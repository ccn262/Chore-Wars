...
begin
  ...
  returning id, chore_id, household_id, completed_by_member_id, points_awarded, completed_at
  into completion_id, chore_id, household_id, household_member_id, points_awarded, completed_at;
...
revoke all on function public.complete_chore_atomically(uuid) from public;
grant execute on function public.complete_chore_atomically(uuid) to authenticated;
