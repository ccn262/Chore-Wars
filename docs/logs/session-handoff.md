...
- household member management is now owner/admin editable for names and chore settings, with archive-only flow and member renaming tightened up
- archived members are paused rather than deleted, and invite rejoin reactivates the same household member row so history stays attached
